    ...
    <>
      <div className="navCon">
        <Navbar collapseOnSelect expand="lg" bg="dark" variant="dark">
          <Container>
            <Navbar.Brand  onClick={executeScroll}> Alimov Asadbek</Navbar.Brand>
      ...
      <div className="futterBox">
        <div className="firstBox">
          <div className="instaBox">
            ...
            <a href="https://www.instagram.com/dasa.cik/">Instagram</a>
          </div>
          <div className="linkedinBox">
            ...
            <a href="https://www.linkedin.com/in/asadbek-alimov-797305238/">
              LinkedIn
            </a>
          </div>
        </div>
        <div className="secondBox">
          <h2>Alimov Asadbek</h2>
          <h3>Junior Front-end Developer</h3>
          <a href="tel: +998-88-122-02-70">+998-88-122-02-70</a>
        </div>
        <div className="thirdBox">
          <div className="telegramBox">
            ...
            <a href="https://t.me/dasacik">Telegram</a>
          </div>
          <div className="gitHubBox">
            ...
            <a href="https://github.com/dasacik">GitHub</a>
          </div>
        </div>
      </div>
    </>
